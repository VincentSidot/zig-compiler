//! Encoder module for XOR instruction forms.
//! This is built from https://www.felixcloutier.com/x86/xor
...
const XOR_OPCODE = struct {
    const XOR_RM8_R8: u8 = 0x30;
    const XOR_RM16_R16: u8 = 0x31;
    const XOR_RM32_R32: u8 = 0x31;
    const XOR_RM64_R64: u8 = 0x31;

    const XOR_R8_RM8: u8 = 0x32;
    const XOR_R16_RM16: u8 = 0x33;
    const XOR_R32_RM32: u8 = 0x33;
    const XOR_R64_RM64: u8 = 0x33;

    const XOR_RM8_IMM8: u8 = 0x80; // /6
    const XOR_RM16_IMM16: u8 = 0x81; // /6
    const XOR_RM32_IMM32: u8 = 0x81; // /6
    const XOR_RM64_IMM32: u8 = 0x81; // /6 + REX.W
};

const Writer = std.io.Writer;

pub const rm8_r8 = factory_op(RegisterMemory8, Register8, XOR_OPCODE.XOR_RM8_R8);
pub const r8_rm8 = factory_op(Register8, RegisterMemory8, XOR_OPCODE.XOR_R8_RM8);

pub const rm16_r16 = factory_op(RegisterMemory16, Register16, XOR_OPCODE.XOR_RM16_R16);
pub const r16_rm16 = factory_op(Register16, RegisterMemory16, XOR_OPCODE.XOR_R16_RM16);

pub const rm32_r32 = factory_op(RegisterMemory32, Register32, XOR_OPCODE.XOR_RM32_R32);
pub const r32_rm32 = factory_op(Register32, RegisterMemory32, XOR_OPCODE.XOR_R32_RM32);

pub const rm64_r64 = factory_op(RegisterMemory64, Register64, XOR_OPCODE.XOR_RM64_R64);
pub const r64_rm64 = factory_op(Register64, RegisterMemory64, XOR_OPCODE.XOR_R64_RM64);

pub const rm8_imm8 = factory_imm(
    RegisterMemory8,
    u8,
    .{ .mode = .modrm_group, .opcode = XOR_OPCODE.XOR_RM8_IMM8, .modrm_reg = 0b110 },
);
pub const rm16_imm16 = factory_imm(
    RegisterMemory16,
    u16,
    .{ .mode = .modrm_group, .opcode = XOR_OPCODE.XOR_RM16_IMM16, .modrm_reg = 0b110 },
);
pub const rm32_imm32 = factory_imm(
    RegisterMemory32,
    u32,
    .{ .mode = .modrm_group, .opcode = XOR_OPCODE.XOR_RM32_IMM32, .modrm_reg = 0b110 },
);
pub const rm64_imm32 = factory_imm(
    RegisterMemory64,
    u32,
    .{ .mode = .modrm_group, .opcode = XOR_OPCODE.XOR_RM64_IMM32, .modrm_reg = 0b110 },
);
